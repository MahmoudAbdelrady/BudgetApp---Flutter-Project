...
import 'package:mainflutterproject/Frontend/Controller/Profile/ChangeEmail/checkcode_controller.dart';
...
class EmailVerifyCode extends StatelessWidget {
  const EmailVerifyCode({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Get.put(EmailCheckCodeController());
    return Scaffold(
      backgroundColor: Colors.white,
      body: GetBuilder<EmailCheckCodeController>(
