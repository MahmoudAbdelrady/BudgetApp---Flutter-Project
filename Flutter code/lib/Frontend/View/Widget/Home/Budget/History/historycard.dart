          ...
          widget: Container(
              ...
              height: home == true
                  ? controller.historyDatalist.length > 3
                      ? 3 * 60
                      : controller.historyDatalist.length * 60
                  : controller.historyDatalist.length * 60,
                          ...
                          Get.defaultDialog(
                              ...
                              actions: [
                                ElevatedButton(
                                    ...
                                    onPressed: () async {
                                      Get.back();
                                      controller.awName = HistoryModel.fromJson(
                                              controller.historyDatalist[index])
                                          .awName!;
                                      controller.awType = HistoryModel.fromJson(
                                              controller.historyDatalist[index])
                                          .awType!;
                                      controller
                                          .transID = HistoryModel.fromJson(
                                              controller.historyDatalist[index])
                                          .transactionID
                                          .toString();
                                      controller
                                          .quantity = HistoryModel.fromJson(
                                              controller.historyDatalist[index])
                                          .quantity
                                          .toString();
